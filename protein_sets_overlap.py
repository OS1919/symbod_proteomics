...
THRESH_DIR = "valid_DEPs/FC5.59_Stab1.2"
...
plt.savefig("valid_DEPs/validation_protein_overlap.png", dpi=180, bbox_inches="tight")
plt.close()
print("Saved valid_DEPs/validation_protein_overlap.png")